	...
	var questionnaire = [
	    ...
	    "answers": [
	      {
	        ...
	        "next": "SAKURA_WHITE_RADIANCE,SAKURA_WHITE_MOISTURISING,SAKURA_WHITENING_MASK,SAKURA_ULTIMATE_SERUM"
	      },
	      {
	        "label": "Dry",
	        //"next": "SAKURA_WHITE_RADIANCE,SAKURA_WHITE_MOISTURISING,SAKURA_WHITE_SLEEPING,SAKURA_WHITENING_MASK,SAKURA_ULTIMATE_SERUM"
	      ...
	      {
	        "label": "Oily",
	        "next": "LIGHT_MULTI_ACTION_WHITENING,SAKURA_WHITE_MOISTURISING"
	      }
	    ]
	  },
	  {
	    ...
	    "answers": [
	      {
	        "label": "Sensitive",
	        "next": "SAKURA_WHITE_MOISTURISING,LIGHT_MULTI_ACTION_WHITENING"
	      },
	      {
	        "label": "Normal",
	        "next": "SAKURA_WHITE_MOISTURISING,LIGHT_MULTI_ACTION_WHITENING"
	  ...
	  },
	  {
	    ...
	    "answers": [
	      ...
	      {
	        "label": "Oily",
	        "next": "DCWHITENINGANDOILCONTROLFOAM,LIGHT_MULTI_ACTION_WHITENING"
	      },
	      {
	        "label": "Dry",
	        //"next": "SAKURA_WHITE_RADIANCE,SAKURA_WHITE_MOISTURISING,SAKURA_WHITE_SLEEPING,SAKURA_WHITENING_MASK,SAKURA_ULTIMATE_SERUM"
	  ...
	  },
	  {
	    ...
	    "answers": [
	      ...
	      {
	        "label": "Normal",
	        "next": "LCMULTIACTIONBRIGHTENINGFOAM,LCMULTIACTIONBRIGHTENINGSCRUB,LCMILKYLIGHTENINGDEWTONER,LIGHT_MULTI_ACTION_WHITENING,LCLIGHTCOMPLETEWHITESPEEDMULTIACTIONWHITENINGCREAM8HOURSSHINE,LCLIGHTENINGPEELOFFMASK,LCMULTIACTIONWHITENING3IN1ESSENCEMASK"
	      },
	      {
	        "label": "Combination",
	        "next": "LCMULTIACTIONBRIGHTENINGFOAM,LCMULTIACTIONBRIGHTENINGSCRUB,LCMILKYLIGHTENINGDEWTONER,LIGHT_MULTI_ACTION_WHITENING,LCLIGHTCOMPLETEWHITESPEEDMULTIACTIONWHITENINGCREAM8HOURSSHINE,LCLIGHTENINGPEELOFFMASK,LCMULTIACTIONWHITENING3IN1ESSENCEMASK"
