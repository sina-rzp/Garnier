...
<!-- Register Content -->
	<div id="content">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<div class="breadcrumb"> <a href="index.php">Home</a> > <a href="garnier-men.php"> Garnier Men </a> > TurboLight Icy Duo Foam White + Oil Control
					</div>
				</div>
								...
								<div class="row" style="padding-bottom:20px;">
									...
									<div class="col-md-3">
										<div class="products-img">
											<img src="images/men/icy-duo/IcyDuoFoamWhite.png">
										</div>
									</div>
