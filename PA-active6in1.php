...
<!-- Register Content -->
	<div id="content">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<div class="breadcrumb"> <a href="index.php">Home</a> > <a href="pure-active.php">Pure Active</a> > Pure Active 6 in 1 Multi-Action Foam
				</div>
								...
								<div class="row" style="padding-bottom:20px;">
									...
									<div class="col-md-3">
										<div class="products-img">
											<img src="images/skin-natural/pureactive6in1multifoam.png">
										</div>
									</div>
